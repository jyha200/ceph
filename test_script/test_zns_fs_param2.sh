...
execute_remote_cmd "/home/jyha/mnt2/for_zns/ceph/test_script/bringup_zns_fs_param.sh $2 $3" jyha 10.0.0.40
...
RBDS=$(seq 1 $NUM_RBD)
sudo ../build/bin/rbd create test_1 -p bench --size 10G --image-shared
