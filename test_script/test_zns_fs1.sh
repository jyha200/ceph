...
execute_remote_cmd "/home/jyha/mnt/my_ceph/ceph/test_script/bringup_zns_fs.sh $2" jyha 10.0.0.40
...
RBDS=$(seq 1 $NUM_RBD)
sudo ../build/bin/rbd create test_1 -p bench --size $3 --image-shared
