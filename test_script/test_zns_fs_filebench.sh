...
execute_remote_cmd "/home/jyha/mnt2/for_zns/ceph/test_script/bringup_zns_fs.sh delta_onode" jyha 10.0.0.40
...
sudo filebench -f /home/jyha/filebench/workloads/$1
sudo umount /mnt_tmp
