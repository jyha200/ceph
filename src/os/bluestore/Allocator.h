...
static const int64_t BLUEFS_ZNS_FS_DATA = 1;
static const int64_t BLUEFS_ZNS_FS_WAL = 2;
static const int64_t BLUEFS_ZNS_FS_FRAG = 3;
static const int64_t BLUEFS_ZNS_DATA = 4;
